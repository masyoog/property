var My = function() {
    var handleBootstrapValidator = function(){
    ...
    var handleInputMask = function(){
        if($().inputmask){
            ...
            $('.date-mask').inputmask("y-m-d", {placeholder: "yyyy/mm/dd"});
            $('.number-mask').inputmask("999.999.999.999", {autoUnmask: true});
        }
    };
