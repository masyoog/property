 ...
 */
define ('K_PATH_CACHE', base_url().'tmp/');
 ...
 * Document creator.
 */
define ('PDF_CREATOR', 'EXIS EXPRESS');

/**
 * Document author.
 */
define ('PDF_AUTHOR', 'EXIS EXPRESS');

/**
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'EXIS EXPRESS - Ini adalah header title');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "EXIS EXPRESS - Ini adalah header string");
