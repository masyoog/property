                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" id="input-nama" name="nama" placeholder="Nama" minlength="0" data-rule-maxlength="30" 
                                                required value="<?php echo set_value('nama', $fields['nama']['value']); ?>" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="col-md-6">
                                                                        <div class="checkbox">
                                                                            <label>
                                                                                <input type="checkbox" class="flat out-item" name="out_cn" id="input-out_cn" value="1"<?php echo (set_value("out_cn") == "1" ? ' checked="checked"' : ''); ?>> Connote / Pickup
                                                                            </label>
                                                                        </div>
                                                                        <div class="checkbox">
                                                                            <label>
                                                                                <input type="checkbox" class="flat out-item" name="out_outgoing" id="input-out_outgoing" value="1"<?php echo (set_value("out_outgoing") == "1" ? ' checked="checked"' : ''); ?>> Outgoing
                                                                            </label>
                                                                        </div>
                                                                        <div class="checkbox">
                                                                            <label>
                                                                                <input type="checkbox" class="flat out-item" name="out_incoming" id="input-out_incoming" value="1"<?php echo (set_value("out_incoming") == "1" ? ' checked="checked"' : ''); ?>> Incoming
                                                                            </label>
                                                                        </div>
                                                                        <div class="checkbox">
                                                                            <label>
                                                                                <input type="checkbox" class="flat out-item" name="out_delivery" id="input-out_delivery" value="1"<?php echo (set_value("out_delivery") == "1" ? ' checked="checked"' : ''); ?>> Delivery
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <div class="checkbox">
                                                                            <label>
                                                                                <input type="checkbox" class="flat out-item" name="out_pod" id="input-out_pod" value="1"<?php echo (set_value("out_pod") == "1" ? ' checked="checked"' : ''); ?>> POD
                                                                            </label>
                                                                        </div>
                                                                        <div class="checkbox">
                                                                            <label>
                                                                                <input type="checkbox" class="flat out-item" name="out_dex" id="input-out_dex" value="1"<?php echo (set_value("out_dex") == "1" ? ' checked="checked"' : ''); ?>> Delivery Exception
                                                                            </label>
                                                                        </div>
                                                                        <div class="checkbox">
                                                                            <label>
                                                                                <input type="checkbox" class="flat out-item" name="out_invoice" id="input-out_invoice" value="1"<?php echo (set_value("out_invoice") == "1" ? ' checked="checked"' : ''); ?>> Invoice
                                                                            </label>
                                                                        </div>
                                                                        <div class="checkbox">
                                                                            <label>
                                                                                <input type="checkbox" class="flat out-item" name="out_payment" id="input-out_payment" value="1"<?php echo (set_value("out_payment") == "1" ? ' checked="checked"' : ''); ?>> Payment
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="col-md-6">
                                                                        <div class="checkbox">
                                                                            <label>
                                                                                <input type="checkbox" class="flat summary-item" name="summary_pickup" id="input-summary_pickup" value="1"<?php echo (set_value("summary_pickup") == "1" ? ' checked="checked"' : ''); ?>> Pickup
                                                                            </label>
                                                                        </div>
                                                                        <div class="checkbox">
                                                                            <label>
                                                                                <input type="checkbox" class="flat summary-item" name="summary_cn" id="input-summary_cn" value="1"<?php echo (set_value("summary_cn") == "1" ? ' checked="checked"' : ''); ?>> Connote
                                                                            </label>
                                                                        </div>
                                                                        <div class="checkbox">
                                                                            <label>
                                                                                <input type="checkbox" class="flat summary-item" name="summary_outgoing" id="input-summary_outgoing" value="1"<?php echo (set_value("summary_outgoing") == "1" ? ' checked="checked"' : ''); ?>> Outgoing
                                                                            </label>
                                                                        </div>
                                                                        <div class="checkbox">
                                                                            <label>
                                                                                <input type="checkbox" class="flat summary-item" name="summary_incoming" id="input-summary_incoming" value="1"<?php echo (set_value("summary_incoming") == "1" ? ' checked="checked"' : ''); ?>> Incoming
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <div class="checkbox">
                                                                            <label>
                                                                                <input type="checkbox" class="flat summary-item" name="summary_delivery" id="input-summary_delivery" value="1"<?php echo (set_value("summary_delivery") == "1" ? ' checked="checked"' : ''); ?>> Delivery
                                                                            </label>
                                                                        </div>
                                                                        <div class="checkbox">
                                                                            <label>
                                                                                <input type="checkbox" class="flat summary-item" name="summary_pod" id="input-summary_pod" value="1"<?php echo (set_value("summary_pod") == "1" ? ' checked="checked"' : ''); ?>> POD
                                                                            </label>
                                                                        </div>
                                                                        <div class="checkbox">
                                                                            <label>
                                                                                <input type="checkbox" class="flat summary-item" name="summary_dex" id="input-summary_dex" value="1"<?php echo (set_value("summary_dex") == "1" ? ' checked="checked"' : ''); ?>> Delivery Exception
                                                                            </label>
                                                                        </div>
                                                                        <div class="checkbox">
                                                                            <label>
                                                                                <input type="checkbox" class="flat summary-item" name="summary_payment" id="input-summary_payment" value="1"<?php echo (set_value("summary_payment") == "1" ? ' checked="checked"' : ''); ?>> Payment
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="col-md-4">
                                                                        <div class="checkbox">
                                                                            <label>
                                                                                <input type="checkbox" class="flat panel-item" name="panel_transaksi" id="input-panel_transaksi" value="1"<?php echo (set_value("panel_transaksi") == "1" ? ' checked="checked"' : ''); ?>> Transaksi
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <div class="checkbox">
                                                                            <label>
                                                                                <input type="checkbox" class="flat panel-item" name="panel_revenue" id="input-panel_revenue" value="1"<?php echo (set_value("panel_revenue") == "1" ? ' checked="checked"' : ''); ?>> Revenue
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <div class="checkbox">
                                                                            <label>
                                                                                <input type="checkbox" class="flat panel-item" name="panel_tracing" id="input-panel_tracing" value="1"<?php echo (set_value("panel_tracing") == "1" ? ' checked="checked"' : ''); ?>> Tracing
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                                </td>
