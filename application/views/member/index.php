                    ...
                    <div class="section-body">
                        ...
                        <div class="row">
                            <div class="col-lg-12 text-right">
                                <button type="button" class="btn ink-reaction btn-raised btn-primary" onclick="location.href='<?php echo base_url().$class_name; ?>/add'"><i class="fa fa-plus-circle fa-fw"></i> Registrasi Member</button>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12">
