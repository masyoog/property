                    ...
                    <div class="section-body">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <form id="my_form" method="post" action="<?php echo base_url().$class_name ?>/activate" class="form form-validate" novalidate="novalidate">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="form-group">
                                                <input type="text" class="form-control" id="input-atas_nama" name="atas_nama" 
                                                    data-rule-minlength="0" maxlength="50" readonly value="<?php echo set_value('atas_nama', $atas_nama); ?>" />
                                                <label for="input-nominal">Transfer Dari Rekening Atas Nama</label>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label">Ke Rekening Bank <span class="danger">*</span></label>
                                                <select class="form-control select2 select2me" required id="input-bank" name="bank" style="width:100%;">
                                                    <option></option>
                                                    <?php
                                                    $id = 'bank';
                                                    if(!empty($bank_list)){
                                                        foreach($bank_list as $key => $val){
                                                            echo '<option value="'.$key.'"'.(set_value($id, $bank)==$key?' selected="selected"':'').'>'.$val.'</option>';
                                                        }
                                                    }
                                                    ?>
                                                </select>
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="input-group-content">
                                                        <input type="text" class="form-control" id="input-nominal" name="nominal" 
                                                            data-rule-minlength="0" maxlength="50" required value="<?php echo set_value('nominal', $nominal); ?>" />
                                        ...
                                        <div class="card-actionbar">
                                            <div class="card-actionbar-row">
                                                ...
                                                <input type="hidden" name="id_konfirmasi" id="input-id_konfirmasi" value="<?php echo $id_konfirmasi;?>">
                                                <button type="submit" class="btn btn-raised btn-primary ink-reaction">Aktivasi</button>&nbsp;
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-condensed table-striped table-hover">
                                                ...
                                                unset($datalist->user_input, $datalist->tgl_input, $datalist->user_update, $datalist->tgl_update);
                                                ...
                                                <tr>
                                                    ...
                                                    <td>:</td>
                                                    <td><?php echo ($key=='status'?_get_status($val):$val); ?></td>
                                                </tr>
                                                <?php
                                                    }
                                                }
