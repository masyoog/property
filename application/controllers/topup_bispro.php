...
class Topup_bispro extends Site_Controller {
    ...
    function index(){
        $data = array(
            "title" => "Topup Dana BISPRO",
            'subtitle' => 'Topup BISPRO',
            'fields' => $this->field,
            'css' => array(
    ...
    function insert() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $create = $this->my_model->topup($data);
            if ($create) {
...
//                    'smtp_crypto' => 'tls',
                ...
                $msg = '
                    Dear '.$member->nama.' ('.$member->id.'), <br>
                        
                    Selamat saldo rekening BISPRO Anda telah berhasil ditambahkan sebesar Rp '._format_angka($data['nominal']).'. <br><br>
