...
class Fee_trx_ppob extends Site_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model('ppob_produk_model', 'my_model');
        
    }
    
    function get_data(){
        $this->datatables->select('g.nama as nama_group, p.kode as kode_produk, p.nama as nama_produk, p.denom as denom, p.fee_member as fee_member, '
                . 'p.fee_upline1 as fee_upline1, p.fee_upline2 as fee_upline2, p.fee_upline3 as fee_upline3, p.fee_upline4 as fee_upline4, p.fee_upline5 as fee_upline5, '
                . 'p.fee_supplier as fee_biller')
                ->add_column('action', $this->get_action_button('$1'), 'kode_produk')
    ...
    private function init($with_value = true){
        $grouplist = array();
        if($with_value){
            $this->load->model('ppob_produk_group_model', 'group_model');
