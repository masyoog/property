...
class Topup_sipro extends Site_Controller {
    ...
    function index(){
        $data = array(
            "title" => "Topup Dana SIPRO",
            'subtitle' => 'Topup SIPRO',
            'fields' => $this->field,
            'css' => array(
...
//                    'smtp_crypto' => 'tls',
                ...
                $msg = '
                    ...
                    Selamat saldo rekening SIPRO Anda telah berhasil ditambahkan sebesar Rp '._format_angka($data['nominal']).'. <br><br>
